...
export async function listBranches(input: ListBranchInput) {
  ...
  const orderCol = sortBy === 'name' ? branches.name : sortBy === 'code' ? branches.code : branches.createdAt;
...
export async function createBranch(input: CreateBranchInput, createdBy: string): Promise<Branch> {
...
export async function updateBranch(id: string, input: UpdateBranchInput, updatedBy: string): Promise<Branch> {
